...
{
// clang-format off
constexpr char licenseKey[] = "";
// clang-format on
...
AppController::createObservers()
{
    ...
    if (mTarget == IMAGE_TARGET_ID)
    {
        ...
        imageTargetConfig.databasePath = "shiji_database.xml";
        imageTargetConfig.targetName = "cover";
